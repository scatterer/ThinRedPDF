...
function [N_coh_ref, N_inc_ref, std_ref] = Monte_Carlo_nomalization_spur(Q, I, f_sqrd, f_av_sqrd, I_compton, num_iterations, span_interval, guess_of_first_peak,...
...
for i = 1:num_iterations
    ...
    [~, ~, ~, ~, G]  = Intensity_to_F_to_PDF_calc_spur(Q, R, I, f_sqrd, f_av_sqrd, I_compton, N_coh, 1, N_spur, window_flag, damp_flag, damping);
    ...
    N_spur = span_interval*(rand - 0.5)./10      + N_spur_ref ;
